...
def extract_histograms(file):
    ...
    for key in file.GetListOfKeys():
        ...
        if isinstance(obj, TH1D):
            cloned_histograms = obj.Clone() # Clona l'istogramma  
...
def main(args):
    ...
    for ii, run_number in enumerate(run_numbers):
        ...
        print(f"Grafico salvato come {output_dir}/run_{run_number}_{args.detector}_PMT07_PMT15.png")
